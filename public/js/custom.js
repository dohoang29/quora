                ...
                success: function(results) {
                  ...
                  results.forEach((result)=>{
                    ...
                    if(result.question != null){
                      $(".searchResult").append("<a href='/question/"+result.question+"' class='search-result-item'><div class='border-bottom p-2 text-dark '><span class='text-muted'>Question: </span>"+result.name+" <i class='fas fa-chevron-right text-muted search-arrow'></i></div></a>")
                    }
        ...
        $(".search-box").blur(function(){
          $(".searchResult").delay("fast").fadeOut();
